...
mutate(ok_percent_era1 = round(ok_percent_era1*100, 3),
ok_percent_era2 = round(ok_percent_era2*100, 3)) %>% 
  datatable()
```
...
mutate(percent_of_allocation_spent_era1 = round(percent_of_allocation_spent_era1*100, 3),
percent_of_allocation_spent_era2 = round(percent_of_allocation_spent_era2*100, 3)) %>% 
  datatable()
```
